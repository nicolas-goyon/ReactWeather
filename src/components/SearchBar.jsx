...
export default function SearchBar({ onSearch }) {
    ...
    async function GeolocationAutoFill(setLocating) {
    ...
    async function AutoCompleteCityInput(input) {
            ...
            <div className="flex items-center justify-center gap-2">
                <div>
                    <input
                        ...
                        onChange={AutoCompleteCityInput}
                    />
                    <div
                ...
                <button
                    onClick={() => GeolocationAutoFill(setLocating)}
                    disabled={locating}
                ...
                <button onClick={() => onSearch(savedCity)} className="bg-green-500 text-white p-2 rounded-md h-10 w-10 flex items-center justify-center">
                    <CiSearch />
                </button>
            </div>
        </div>
